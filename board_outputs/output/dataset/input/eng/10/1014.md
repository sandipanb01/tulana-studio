...
$$\text{P(E)} = \frac{\text{Number of outcomes favourable to E}}{\text{Number of all possible outcomes of the experiment}},$$
...
playing cards? It consists of 52 cards which are divided into 4 suits of 13 cards eachspades ($\spades$), hearts ($\heartsuit$), diamonds ($\spadesuit$) and clubs ($\spadesuit$). Clubs and spades are of black
...
Remark : Note that F is nothing but $\overline{\text{E}}$ . Therefore, we can also calculate P(F) as
