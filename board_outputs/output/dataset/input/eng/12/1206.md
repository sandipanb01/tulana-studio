...
of change of the area A with respect to its radius $r$ is given by $\frac{dA}{dr} = \frac{d}{dr}(\pi r^2) = 2\pi r$.
...
Therefore $9 = \frac{dV}{dt} = \frac{d}{dt}(x^3) = \frac{d}{dx}(x^3) \cdot \frac{dx}{dt}$ (By Chain Rule)

$$= 3x^2 \cdot \frac{dx}{dt}$$

or $$\frac{dx}{dt} = \frac{3}{x^2} \dots (1)$$

Now $\frac{dS}{dt} = \frac{d}{dt}(6x^2) = \frac{d}{dx}(6x^2) \cdot \frac{dx}{dt}$ (By Chain Rule)

$$= 12x \cdot \left( \frac{3}{x^2} \right) = \frac{36}{x} \qquad \text{(Using (1))}$$
...
of $4\text{cm}$ per second. At the instant, when the radius of the circular wave is $10\text{ cm}$, how
fast is the enclosed area increasing?

Solution The area A of a circle with radius $r$ is given by $A = \pi r^2$. Therefore, the rate
of change of area A with respect to time $t$ is

$$\frac{dA}{dt} = \frac{d}{dt}(\pi r^2) = \frac{d}{dr}(\pi r^2) \cdot \frac{dr}{dt} = 2\pi r \frac{dr}{dt} \qquad \text{(By Chain Rule)}$$

It is given that $\frac{dr}{dt} = 4\text{cm/s}$

Therefore, when $r = 10$ cm, $\frac{dA}{dt} = 2\pi (10) (4) = 80\pi$
...
the width $y$ is increasing at the rate of 2cm/minute. When $x=10\text{cm}$ and $y=6\text{cm}$, find
...
$\frac{dx}{dt} = -3 \text{ cm/min}$ and $\frac{dy}{dt} = 2 \text{ cm/min}$

(a) The perimeter P of a rectangle is given by

$$P = 2(x + y)$$

Therefore $$\frac{dP}{dt} = 2\left(\frac{dx}{dt} + \frac{dy}{dt}\right) = 2(-3 + 2) = -2 \text{ cm/min}$$

(b) The area A of the rectangle is given by

$$A = x . y$$

Therefore $$\begin{aligned} \frac{dA}{dt} &= \frac{dx}{dt} \cdot y + x \cdot \frac{dy}{dt} \\ &= -3(6) + 10(2) \quad (\text{as } x = 10 \text{ cm and } y = 6 \text{ cm}) \\ &= 2 \text{ cm}^2/\text{min} \end{aligned}$$
...
Marginal cost (MC) = $\frac{dC}{dx}$ = 0.005(3$x^2$) - 0.02(2$x$) + 30
...
$$Marginal Revenue \quad (MR) = \frac{dR}{dx} = 6x + 36$$

When $x = 5, \text{MR} = 6(5) + 36 = 66$
...
(a) $r = 3$ cm                                     (b) $r = 4$ cm
2. The volume of a cube is increasing at the rate of $8$ cm$^3$/s. How fast is the
...
<!-- page 4 -->
6. The radius of a circle is increasing at the rate of $0.7 \text{ cm/s}$. What is the rate of
increase of its circumference?

7. The length $x$ of a rectangle is decreasing at the rate of 5 cm/minute and the
width $y$ is increasing at the rate of 4 cm/minute. When $x = 8\text{cm}$ and $y = 6\text{cm}$, find
the rates of change of (a) the perimeter, and (b) the area of the rectangle.
...
11. A particle moves along the curve $6y = x^3 + 2$. Find the points on the curve at
which the $y$-coordinate is changing 8 times as fast as the $x$-coordinate.

12. The radius of an air bubble is increasing at the rate of $\frac{1}{2}$ cm/s. At what rate is the
volume of the bubble increasing when the radius is 1 cm?

13. A balloon, which always remains spherical, has a variable diameter $\frac{3}{2}(2x+1)$.
Find the rate of change of its volume with respect to $x$.

14. Sand is pouring from a pipe at the rate of $12 \text{ cm}^3/\text{s}$. The falling sand forms a cone
...
Consider the function $f$ given by $f(x) = x^2, x \in \mathbf{R}$. The graph of this function is a
...
(i) increasing on I if $x_1 < x_2$ in I $\Rightarrow f(x_1) \leq f(x_2)$ for all $x_1, x_2 \in$ I.
(ii) decreasing on I, if $x_1 < x_2$ in I $\Rightarrow f(x_1) \geq f(x_2)$ for all $x_1, x_2 \in$ I.
(iii) constant on I, if $f(x) = c$ for all $x \in$ I, where $c$ is a constant.

<!-- page 6 -->
(iv) strictly increasing on I if $x_1 < x_2$ in I $\Rightarrow f(x_1) < f(x_2)$ for all $x_1, x_2 \in$ I.
...
Definition 2 Let $x_0$ be a point in the domain of definition of a real valued function $f$.
...
Solution Let $x_1$ and $x_2$ be any two numbers in $\mathbf{R}$. Then

$$x_1 < x_2 \Rightarrow 7x_1 < 7x_2 \Rightarrow 7x_1 - 3 < 7x_2 - 3 \Rightarrow f(x_1) < f(x_2)$$
...
(a) $f$ is increasing in $[a,b]$ if $f'(x) \geq 0$ for each $x \in (a, b)$

(b) $f$ is decreasing in $[a,b]$ if $f'(x) \leq 0$ for each $x \in (a, b)$
...
i.e. $$f(x_2) - f(x_1) > 0 \quad \text{(as } f'(c) > 0 \text{ (given)})$$
i.e. $$f(x_2) > f(x_1)$$

Thus, we have

$$x_1 < x_2 \Rightarrow f(x_1) < f(x_2), \text{ for all } x_1, x_2 \in [a,b]$$
...
There is a more generalised theorem, which states that if $f\cancel{c}(x) > 0$ for $x$ in an interval
excluding the end points and $f$ is continuous in the interval, then $f$ is increasing. Similarly,
if $f\cancel{c}(x) < 0$ for $x$ in an interval excluding the end points and $f$ is continuous in the
...
(a) Since for each $x \in (0, \pi)$, $\sin x > 0$, we have $f'(x) < 0$ and so $f$ is decreasing in
$(0, \pi)$.

(b) Since for each $x \in (\pi, 2\pi)$, $\sin x < 0$, we have $f'(x) > 0$ and so $f$ is increasing in
$(\pi, 2\pi)$.
...
disjoint intervals namely, $(-\infty, 2)$ and $(2, \infty)$ (Fig 6.3). In the interval $(-\infty, 2), f'(x) = 2x$
$- 4 < 0$.

Therefore, $f$ is decreasing in this interval. Also, in the interval $(2, \infty)$ , $f'(x) > 0$
and so the function $f$ is increasing in this interval.

Example 11 Find the intervals in which the function $f$ given by $f(x) = 4x^3 - 6x^2 - 72x$
...
three disjoint intervals, namely, $(-\infty, -2), (-2, 3)$
and $(3, \infty)$.

Fig 6.4

<!-- page 9 -->
In the intervals $(-\infty, -2)$ and $(3, \infty), f'(x)$ is positive while in the interval $(-2, 3)$,
$f'(x)$ is negative. Consequently, the function $f$ is increasing in the intervals
$(-\infty, -2)$ and $(3, \infty)$ while the function is decreasing in the interval $(-2, 3)$. However,
$f$ is neither increasing nor decreasing in $\mathbf{R}$.
...
Example 12 Find intervals in which the function given by $f(x) = \sin 3x$, $x \in \left[ 0, \frac{\pi}{2} \right]$ is
(a) increasing (b) decreasing.
...
Therefore, $f'(x) = 0$ gives $\cos 3x = 0$ which in turn gives $3x = \frac{\pi}{2}, \frac{3\pi}{2}$ (as $x \in \left[ 0, \frac{\pi}{2} \right]$)

implies $3x \in \left[0, \frac{3\pi}{2}\right]$. So $x = \frac{\pi}{6}$ and $\frac{\pi}{2}$. The point $x = \frac{\pi}{6}$ divides the interval $\left[0, \frac{\pi}{2}\right]$ into two disjoint intervals $\left[0, \frac{\pi}{6}\right)$ and $\left(\frac{\pi}{6}, \frac{\pi}{2}\right)$.

Fig 6.5

Now, $f'(x) > 0$ for all $x \in \left[ 0, \frac{\pi}{6} \right)$ as $0 \le x < \frac{\pi}{6} \Rightarrow 0 \le 3x < \frac{\pi}{2}$ and $f'(x) < 0$ for

all $x \in \left( \frac{\pi}{6}, \frac{\pi}{2} \right)$ as $\frac{\pi}{6} < x < \frac{\pi}{2} \Rightarrow \frac{\pi}{2} < 3x < \frac{3\pi}{2}$.
...
$$f \text{ is increasing on } \left[ 0, \frac{\pi}{6} \right] \text{ and decreasing on } \left[ \frac{\pi}{6}, \frac{\pi}{2} \right].$$
...
Now $f'(x) = 0$ gives $\sin x = \cos x$ which gives that $x = \frac{\pi}{4}$, $\frac{5\pi}{4}$ as $0 \le x \le 2\pi$

The points $x = \frac{\pi}{4}$ and $x = \frac{5\pi}{4}$ divide the interval $[0, 2\pi]$ into three disjoint intervals,
...
(a) increasing in $\left(0, \frac{\pi}{2}\right)$ (b) decreasing in $\left(\frac{\pi}{2}, \pi\right)$
...
(e) $(x + 1)^3 (x - 3)^3$
7. Show that $y = \log(1 + x) - \frac{2x}{2 + x}$, $x > -1$, is an increasing function of $x$
...
11. Prove that the function $f$ given by $f(x) = x^2 - x + 1$ is neither strictly increasing
...
13. On which of the following intervals is the function $f$ given by $f(x) = x^{100} + \sin x - 1$
decreasing ?
...
16. Prove that the function $f$ given by $f(x) = \log \sin x$ is increasing on $\left(0, \frac{\pi}{2}\right)$ and


decreasing on $\left(\frac{\pi}{2}, \pi\right)$.

17. Prove that the function $f$ given by $f(x) = \log |\cos x|$ is decreasing on $\left(0, \frac{\pi}{2}\right)$ and

increasing on $\left(\frac{3\pi}{2}, 2\pi\right)$.
...
(i) The profit from a grove of orange trees is given by $P(x) = ax + bx^2$, where $a,b$
...
given by $h(x) = 60 + x - \frac{x^2}{60}$, where $x$ is the horizontal distance from the building
...
$f(x) = x^2 + 7$. A soldier, placed at the point $(1, 2)$, wants to shoot the helicopter
...
$\textit{\textbf{Remark}}$ In Fig 6.7(a), (b) and (c), we have exhibited that graphs of certain particular
...
and hence no point of maximum value of $f$ in $\mathbf{R}$.
...
of $f$, if any, of the function given by $f(x) = |x|, x \in \mathbf{R}$.

Solution From the graph of the given function
(Fig 6.9) , note that

$$f(x) \geq 0, \text{ for all } x \in \mathbf{R} \text{ and } f(x) = 0 \text{ if } x = 0.$$

Therefore, the function $f$ has a minimum value 0
and the point of minimum value of $f$ is $x = 0$. Also, the
graph clearly shows that $f$ has no maximum value in $\mathbf{R}$
and hence no point of maximum value in $\mathbf{R}$.
...
we find $\frac{x_0}{2} < x_0$ for all $x_0 \in (0,1)$. Also, if $x_1$ is closest

to 1, then $\frac{x_1 + 1}{2} > x_1$ for all $x_1 \in (0,1)$.

Therefore, the given function has neither the
maximum value nor the minimum value in the interval $(0,1)$.

$\mathit{Remark}$ The reader may observe that in Example 16, if we include the points 0 and 1
...
<!-- page 18 -->
If $c$ is a point of local maxima of $f$, then $f(c)$ is a local maximum value of
...
or
$$f'(x) = 0 \text{ at } x = 1 \text{ and } x = -1$$

Thus, $x = \pm 1$ are the only critical points which could possibly be the points of local
...
<tbody>
<tr>
<td>Close to 1 $\begin{cases} \text{to the right (say } 1.1 \text{ etc.)} \\ \text{to the left (say } 0.9 \text{ etc.)} \end{cases}$</td>
<td>$>0$<br/>$<0$</td>
</tr>
<tr>
<td>Close to $-1$ $\begin{cases} \text{to the right (say } -0.9 \text{ etc.)} \\ \text{to the left (say } -1.1 \text{ etc.)} \end{cases}$</td>
<td>$<0$<br/>$>0$</td>
</tr>
</tbody>
</table>
...
$$f'(x) = 0 \quad \text{at} \quad x = 1$$

Thus, $x = 1$ is the only critical point of $f$. We shall now examine this point for local
maxima and/or local minima of $f$. Observe that $f'(x) \geq 0$, for all $x \in \mathbf{R}$ and in particular
...
$\mathit{Remark}$ One may note that since $f'(x)$, in Example 30, never changes its sign on $\mathbf{R}$,
...
and $c \in \mathrm{I}$. Let $f$ be twice differentiable at $c$. Then
...
given by $f(x) = 3 + |x|, x \in \mathbf{R}$.
...
or $$f'(x) = 0 \text{ at } x = 0, x = 1 \text{ and } x = -2.$$
Now $$f''(x) = 36x^2 + 24x - 24 = 12(3x^2 + 2x - 2)$$

$$\text{or} \quad \begin{cases} f''(0) &= -24 < 0 \\ f''(1) &= 36 > 0 \\ f''(-2) &= 72 > 0 \end{cases}$$
...
or $$\begin{cases} f'(x) = 6x^2 - 12x + 6 = 6(x-1)^2 \\ f''(x) = 12(x-1) \end{cases}$$
...
or $\begin{cases} S'(x) = 4x - 30 \\ S''(x) = 4 \end{cases}$

Now $S'(x)=0$ gives $x=\frac{15}{2}$. Also $S''\left(\frac{15}{2}\right)=4>0$. Therefore, by second derivative

test, $x = \frac{15}{2}$ is the point of local minima of S. Hence the sum of squares of numbers is

minimum when the numbers are $\frac{15}{2}$ and $15-\frac{15}{2}=\frac{15}{2}$.

$\textit{Remark}$ Proceeding as in Example 34 one may prove that the two positive numbers,

whose sum is $k$ and the sum of whose squares is minimum, are $\frac{k}{2}$ and $\frac{k}{2}$.

Example 23 Find the shortest distance of the point $(0, c)$ from the parabola $y = x^2$,

where $\frac{1}{2} \le c \le 5$.

Solution Let $(h, k)$ be any point on the parabola $y = x^2$. Let D be the required distance
...
or $$D'(k) = \frac{1 + 2(k - c)}{2\sqrt{k + (k - c)^2}}$$

Now $D'(k) = 0$ gives $k = \frac{2c-1}{2}$

Observe that when $k < \frac{2c - 1}{2}$ , then $2(k - c) + 1 < 0$ , i.e., $\text{D}'(k) < 0$ . Also when

$k > \frac{2c - 1}{2}$ , then $\text{D}'(k) > 0$ . So, by first derivative test, $\text{D} (k)$ is minimum at $k = \frac{2c - 1}{2}$ .
...
AB from the point A such that $\text{RP}^2 + \text{RQ}^2$ is minimum.
...
$$\text{and} \quad \text{Therefore} \quad \begin{aligned} \text{RP}^2 &= \text{AR}^2 + \text{AP}^2 \\ \text{RQ}^2 &= \text{RB}^2 + \text{BQ}^2 \\ \text{RP}^2 + \text{RQ}^2 &= \text{AR}^2 + \text{AP}^2 + \text{RB}^2 + \text{BQ}^2 \\ &= x^2 + (16)^2 + (20 - x)^2 + (22)^2 \\ &= 2x^2 - 40x + 1140 \end{aligned} \quad \text{Fig 6.1}$$

Let $S \equiv S(x) = RP^2 + RQ^2 = 2x^2 - 40x + 1140.$
...
<!-- page 23 -->
CQ on AB. Let AP $= x$ cm. Note that $\Delta$APD $\sim \Delta$BQC. Therefore, QB $= x$ cm. Also, by
Pythagoras theorem, DP = QC $= \sqrt{100 - x^2}$ . Let A be the area of the trapezium. Then

$$A \equiv A(x) = \frac{1}{2} (\text{sum of parallel sides}) (\text{height})$$
$$= \frac{1}{2} (2x + 10 + 10) (\sqrt{100 - x^2})$$
$$= (x + 10) (\sqrt{100 - x^2})$$

or $A'(x) = (x+10)\frac{(-2x)}{2\sqrt{100-x^2}} + \left(\sqrt{100-x^2}\right)$
...
$$A''(x) = \frac{\sqrt{100-x^2}(-4x-10)-(-2x^2-10x+100)\frac{(-2x)}{2\sqrt{100-x^2}}}{100-x^2}$$

$$= \frac{2x^3-300x-1000}{(100-x^2)^{\frac{3}{2}}} \text{ (on simplification)}$$

or $A''(5) = \frac{2(5)^3 - 300(5) - 1000}{(100 - (5)^2)^{\frac{3}{2}}} = \frac{-2250}{75\sqrt{75}} = \frac{-30}{\sqrt{75}} < 0$

Thus, area of trapezium is maximum at $x = 5$ and the area is given by

$$A(5) = (5+10)\sqrt{100 - (5)^2} = 15\sqrt{75} = 75\sqrt{3} \text{ cm}^2$$
...
Solution Let $\text{OC} = r$ be the radius of the cone and $\text{OA} = h$ be its height. Let a cylinder
with radius $\text{OE} = x$ inscribed in the given cone (Fig 6.18). The height $\text{QE}$ of the cylinder
is given by
...
or $$\begin{cases} \mathrm{S}'(x) = \frac{2\pi h}{r}(r - 2x) \\ \mathrm{S}''(x) = \frac{-4\pi h}{r} \end{cases}$$

Now $S'(x) = 0$ gives $x = \frac{r}{2}$. Since $S''(x) < 0$ for all $x$, $S''\left(\frac{r}{2}\right) < 0$. So $x = \frac{r}{2}$ is a
...
$$f(x) = 2x^3 - 15x^2 + 36x + 1 \text{ on the interval } [1, 5].$$
...
$$f(x)=12x^{\frac{4}{3}}-6x^{\frac{1}{3}}, x\in[-1,1]$$
...
Thus, $f'(x) = 0$ gives $x = \frac{1}{8}$. Further note that $f'(x)$ is not defined at $x = 0$. So the

critical points are $x=0$ and $x=\frac{1}{8}$. Now evaluating the value of $f$ at critical points

$x=0, \frac{1}{8}$ and at end points of the interval $x=-1$ and $x=1$, we have
...
and absolute minimum value of $f$ is $\frac{-9}{4}$ that occurs at $x = \frac{1}{8}$.
...
$$\sqrt{(x-3)^2 + (x^2 + 7 - 7)^2} \text{ , i.e., } \sqrt{(x-3)^2 + x^4} \text{ .}$$
...
$f(1) = (1 - 3)^2 + (1)^4 = 5$. Thus, the distance between the solder and the helicopter is
$$\sqrt{f(1)} = \sqrt{5} \text{ .}$$
...
(v) $f(x) = x^3 - 6x^2 + 9x + 15$      (vi) $g(x) = \frac{x}{2} + \frac{2}{x}, \ x > 0$
...
10. Find the maximum value of $2x^3 - 24x + 107$ in the interval $[1, 3]$. Find the
...
15. Find two positive numbers $x$ and $y$ such that their sum is 35 and the product $x^2y^5$
is a maximum.
...
vertical and vertex lowermost. Its semi-vertical angle is $\tan^{-1}(0.5)$. Water is poured
...
Therefore $\frac{dV}{dt} = \frac{d}{dh} \left( \frac{\pi h^3}{12} \right) \cdot \frac{dh}{dt}$ (by Chain Rule)

$$= \frac{\pi}{4} h^2 \frac{dh}{dt}$$

Now rate of change of volume, i.e., $\frac{dV}{dt} = 5 \text{ m}^3/\text{h}$ and $h = 4 \text{ m}$.

Therefore $5 = \frac{\pi}{4}(4)^2 \cdot \frac{dh}{dt}$

or $$\frac{dh}{dt} = \frac{5}{4\pi} = \frac{35}{88} \text{ m/h} \left( \pi = \frac{22}{7} \right)$$
...
Note that $\Delta$MSN $\sim$ $\Delta$ASB

or $$\frac{\text{MS}}{\text{AS}} = \frac{\text{MN}}{\text{AB}}$$
...
Therefore $\frac{dl}{dt} = 2\frac{ds}{dt}$
...
disjoint intervals namely, $(-\infty, -2), (-2, 1), (1, 3)$
and $(3, \infty)$ (Fig 6.22).
...
Therefore, $f'(x) < 0$ when $-\infty < x < -2.$
...
Finally, consider the interval $(3, \infty)$, i.e., when $x > 3$. In this case, we have $x - 1 > 0$,
...
<!-- page 34 -->
$$= \frac{\cos x - \sin x}{2 + \sin 2x} \qquad \text{(on simplification)}$$
...
Thus $f'(x) > 0$ in $\left(0, \frac{\pi}{4}\right)$
...
or $$\frac{dA}{dt} = 2\pi r \frac{dr}{dt} \qquad \text{(by Chain Rule)}$$

Now approximate rate of increase of radius $= dr = \frac{dr}{dt} \Delta t = 0.05 \text{ cm/s.}$

Therefore, the approximate rate of increase in area is given by

$$dA = \frac{dA}{dt}(\Delta t) = 2\pi r \left( \frac{dr}{dt} \Delta t \right)$$
$$= 2\pi (3.2) (0.05) = 0.320\pi \text{ cm}^2/\text{s} \quad (r = 3.2 \text{ cm})$$
...
Therefore $\begin{cases} V'(x) = 12x^2 - 44x + 24 = 4(x-3)(3x-2) \\ V''(x) = 24x - 44 \end{cases}$

Now $\quad \quad \quad \quad \quad \quad \quad \quad \text{V}'(x) = 0$ gives $x = 3, \frac{2}{3}$. But $x \neq 3$ (Why?)

Thus, we have $x = \frac{2}{3}$. Now $V'' \left( \frac{2}{3} \right) = 24 \left( \frac{2}{3} \right) - 44 = -28 < 0$.
...
Example 37 Manufacturer can sell $x$ items at a price of rupees $\left(5 - \frac{x}{100}\right)$ each. The
...
or $$\mathrm{P}'(x) = \frac{24}{5} - \frac{x}{50}$$
...
<!-- page 37 -->
5. Find the maximum area of an isosceles triangle inscribed in the ellipse $\frac{x^2}{a^2} + \frac{y^2}{b^2} = 1$
...
constructed so that its depth is 2 m and volume is 8 $m^3$. If building of tank costs
...
inscribed in a sphere of radius $r$ is $\frac{4r}{3}$.

13. Let $f$ be a function defined on $[a, b]$ such that $f'(x) > 0$, for all $x \in (a, b)$. Then
...
a sphere of radius R is $\frac{2R}{\sqrt{3}}$. Also find the maximum volume.
...
$\frac{dy}{dx}_{x=x_0}$ (or $f'(x_0)$) represents the rate of change of $y$ with respect to $x$ at
$x = x_0$.
...
$x_1 < x_2$ in $(a, b) \Rightarrow f(x_1) < f(x_2)$ for all $x_1, x_2 \in (a, b)$.
...
$\blacklozenge$ \textit{\textbf{Second Derivative Test}} Let $f$ be a function defined on an interval I and
$c \in \text{I}$. Let $f$ be twice differentiable at $c$. Then
